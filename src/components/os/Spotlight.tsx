            ...
            <Command className="flex flex-col">
              <div className="flex items-center px-4">
                ...
                <CommandInput
                  ...
                  className="flex-1 bg-transparent border-none outline-none text-lg placeholder:text-muted-foreground/50 h-14"
                />
              </div>
              <CommandList className="max-h-[300px] overflow-y-auto p-2 custom-scrollbar">
                <CommandEmpty className="py-6 text-center text-sm text-muted-foreground">No results found.</CommandEmpty>
                <CommandGroup heading="Applications" className="px-2 py-1 text-[11px] font-bold text-muted-foreground uppercase tracking-widest">
                  {APPS.map((app) => (
                    <CommandItem
                      key={app.type}
